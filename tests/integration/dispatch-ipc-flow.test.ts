...
describe('Dispatch IPC Flow — Phase 2b Integration', () => {
  ...
  // INT-IPC-001: createGroupChat with leaderAgentId (G3.1: modelOverride and seedMessages removed)
  describe('INT-IPC-001: createGroupChat with leader agent params', () => {
    ...
    it('uses default gemini model (G3.1: modelOverride removed)', async () => {
      await providerHandlers['createGroupChat']({
        name: 'Default Model Chat',
        leaderAgentId: 'leader-agent-1',
      });
