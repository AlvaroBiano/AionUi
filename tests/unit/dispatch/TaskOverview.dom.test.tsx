...
vi.mock(
  '@/renderer/pages/conversation/dispatch/components/TaskOverview.module.css',
  () => ({
    default: new Proxy(
      {},
      {
...
describe('TaskOverview', () => {
  ...
  it('TO-002: clicking header triggers onToggleCollapse', () => {
    ...
    render(
      <TaskOverview {...defaultProps} onToggleCollapse={onToggle} children={[makeChild()]} />,
    );
  ...
  it('TO-004: status dot has correct class for each status', () => {
    ...
    const { container } = render(
      <TaskOverview {...defaultProps} children={children} />,
    );
  ...
  it('TO-007: shows People icon when no dispatcher avatar', () => {
    ...
    render(
      <TaskOverview
        {...defaultProps}
        dispatcherAvatar={undefined}
        children={[makeChild({ teammateAvatar: 'star' })]}
      />,
    );
  ...
  it('TO-008: collapsed state adds collapsed CSS class', () => {
    const { container } = render(
      <TaskOverview {...defaultProps} collapsed={true} children={[makeChild()]} />,
    );
  ...
  it('TO-009: expanded state shows Up icon', () => {
    render(
      <TaskOverview {...defaultProps} collapsed={false} children={[makeChild()]} />,
    );
  ...
  it('TO-012: Enter key on child row triggers onSelectChild', () => {
    ...
    render(
      <TaskOverview {...defaultProps} onSelectChild={onSelect} children={children} />,
    );
