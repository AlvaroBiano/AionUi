...
export const bianinho = {
  ...
  ragStats: bridge.buildProvider<Record<string, unknown>, Record<string, never>>('bianinho.ragStats'),
  ragSearch: bridge.buildProvider<Record<string, unknown>, { query: string; category?: string; topK?: number; accessLevel?: string }>('bianinho.ragSearch'),
  ragBackup: bridge.buildProvider<Record<string, unknown>, { label?: string }>('bianinho.ragBackup'),
  inboxList: bridge.buildProvider<{ count: number; items: Array<Record<string, unknown>> }, Record<string, never>>('bianinho.inboxList'),
  inboxAdd: bridge.buildProvider<Record<string, unknown>, { content: string; priority?: string; tags?: string[]; source?: string }>('bianinho.inboxAdd'),
  inboxDone: bridge.buildProvider<Record<string, unknown>, { id: string }>('bianinho.inboxDone'),
  inboxDelete: bridge.buildProvider<Record<string, unknown>, { id: string }>('bianinho.inboxDelete'),
  cycleStatus: bridge.buildProvider<Record<string, unknown>, Record<string, never>>('bianinho.cycleStatus'),
  cycleTrigger: bridge.buildProvider<Record<string, unknown>, Record<string, never>>('bianinho.cycleTrigger'),
  memoryGet: bridge.buildProvider<Record<string, unknown>, { key: string }>('bianinho.memoryGet'),
  memorySet: bridge.buildProvider<Record<string, unknown>, { key: string; value: string }>('bianinho.memorySet'),
};
