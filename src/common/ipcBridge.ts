...
export const application = {
  ...
  getApiDiagnosticsState: bridge.buildProvider<IBridgeResponse<IApiDiagnosticsConfig>, void>(
    'app.get-api-diagnostics-state'
  ),
  updateApiDiagnosticsConfig: bridge.buildProvider<
    IBridgeResponse<IApiDiagnosticsConfig>,
    Partial<IApiDiagnosticsConfig>
  >('app.update-api-diagnostics-config'),
  captureApiDiagnosticsSnapshot: bridge.buildProvider<
    IBridgeResponse<IApiDiagnosticsCaptureResult>,
    { sessionId?: string; persist?: boolean }
  >('app.capture-api-diagnostics-snapshot'),
  getApiDiagnosticsLiveSnapshot: bridge.buildProvider<
    IBridgeResponse<IApiDiagnosticsCaptureResult>,
    { sessionId?: string } | undefined
  >('app.get-api-diagnostics-live-snapshot'),
  getApiDiagnosticsHistory: bridge.buildProvider<
    IBridgeResponse<IApiDiagnosticsHistoryResult>,
...
export const database = {
  ...
  saveApiConfig: bridge.buildProvider<
    { success: boolean; error?: string },
    Partial<import('@/common/storage').IApiConfig>
  >('database.save-api-config'),
