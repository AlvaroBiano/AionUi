...
export type I18nKey =
  ...
  | 'conversation.cliSessions.continue'
  | 'conversation.cliSessions.empty'
  | 'conversation.cliSessions.entry'
  | 'conversation.cliSessions.importFailed'
  | 'conversation.cliSessions.importedBadge'
  | 'conversation.cliSessions.loadFailed'
  | 'conversation.cliSessions.openExisting'
  | 'conversation.cliSessions.title'
