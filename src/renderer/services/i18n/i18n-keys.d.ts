...
export type I18nKey =
  ...
  | 'conversation.contextUsage.cachedInputTokens'
  | 'conversation.contextUsage.cachedOutputTokens'
  | 'conversation.contextUsage.contextUsed'
  | 'conversation.contextUsage.contextWindow'
  | 'conversation.contextUsage.criticalWarning'
  | 'conversation.contextUsage.highWarning'
  | 'conversation.contextUsage.inputTokens'
  | 'conversation.contextUsage.outputTokens'
  | 'conversation.contextUsage.reasoningTokens'
  | 'conversation.contextUsage.title'
  | 'conversation.contextUsage.totalTokens'
