...
export type I18nKey =
  ...
  | 'pet.hide'
  | 'pet.pat'
  | 'pet.pomodoroBreakDone'
  | 'pet.pomodoroBreakDoneBody'
  | 'pet.pomodoroBreakDurationLabel'
  | 'pet.pomodoroBreaking'
  | 'pet.pomodoroFocusDone'
  | 'pet.pomodoroFocusDoneBody'
  | 'pet.pomodoroFocusDurationLabel'
  ...
  | 'pet.pomodoroToastDismiss'
  | 'pet.pomodoroToastRest'
  | 'pet.pomodoroToastStartFocus'
  | 'pet.resetPosition'
  | 'pet.showHide'
  | 'pet.size'
  | 'pet.sizeLarge'
